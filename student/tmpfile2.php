...
$str = "INSERT INTO ".$FName." (UID, WID, Date, TF, Time, Understand, EndSentence, hesitate, hesitate1, hesitate2, comments, `check`, test_id, attempt, CorrectAnswer)"
        ." VALUES(".$MemberID.",".$_GET['param1'].",\"".$_GET['param2']."\",".$_GET['param3'].",".$_GET['param4'].",".$_GET['param5'].",\"".$_GET['param6']."\",\"".$_GET['param7']."\",\"".$_GET['param8']."\",\"".$_GET['param9']."\",\"".$_GET['param10']."\",".$_GET['param11'].",".$_SESSION['Qid'].",".$attempt.",\"".$_GET['param12']."\")";
//ファイル書き込みコード
